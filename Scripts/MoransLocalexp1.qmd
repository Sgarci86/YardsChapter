...
#FinalFileMoranLocal$Moran.dist.class = as.numeric(FinalFileMoranLocal$Moran.dist.class)

ggplot(MoransLocalexp1finalfile, aes(x = Moran.dist.class, y = Moran.local, color = Yard.Diff,  
  shape= Yard.Diff)) +
  geom_point(alpha = 0.2) + geom_smooth(se = FALSE) + 
  geom_hline(yintercept = 0, linetype = 'longdash') +
  facet_grid(vars(Neighbor.Distance), vars(Happy.Type), labeller = "label_both") +
  labs(x = "Yard Distance", y = "Moran I", title = "Local Moran I Over 30 Yards") + theme_minimal() 
...
MoransLocalexp1finalfile$Yard.Diff = as.factor(MoransLocalexp1finalfile$Yard.Diff)
 ...
 ggplot(MoransLocalexp1finalfile, aes(x = as.numeric(as.character(Moran.dist.class)), y = Moran.local, color = Yard.Diff,
  ...
  geom_hline(yintercept = 0, linetype = 'longdash') + facet_grid(vars(Neighbor.Distance), vars(Happy.Type), labeller = "label_both") +
  labs(x = "Yard Distance", y = "Moran I", title = "Local Moran I Over 30 Yards", subtitle = "No Contraints, Mimicry")  + theme_bw() 
```
